...
/**
 * Created by weichangtan on 16/1/10.
 */
public class AskWeek extends baseTask{
    ...
    public static void saynowWeek(String result){
        ...
        Matcher weekmatcher = Pattern.compile("(?<result>.+)?星期几?.+").matcher(result);
        if (weekmatcher.find()) {
            location = weekmatcher.group("result");
            ...
            String date = saylocation + saywitchday + ":" + saydayofweek;
