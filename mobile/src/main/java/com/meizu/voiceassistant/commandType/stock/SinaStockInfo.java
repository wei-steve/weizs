...
//	private String mWeizhi;
	...
	private SinaStockInfo(String name, float todayPrice, float yestodayPrice, 
							...
							float buy1Price, float sell1Price, float tradeCount, float tradeMoney,
...
//		mWeizhi=weizhi;
	...
	public static SinaStockInfo parseStockInfo(String source) throws ParseStockInfoException {
		...
		final float tradeCount = Float.parseFloat(infoStr[8]);
		...
		final String weizhi = infoStr[32];
	...
	public String getPercentPrice() {
		mPercentPrice=(mNowPrice-mYestodayPrice)/mYestodayPrice;
		NumberFormat nf = NumberFormat.getPercentInstance();
		nf.setMaximumFractionDigits(2);
		String he=nf.format(mPercentPrice);
