...
//		Log.d("看看路径", classPath+"/TimeExp.m");
//		System.out.println(classPath+"/TimeExp.m");
		String path = "/sdcard/TimeExp.m";
		com.time3.nlp.TimeNormalizer normalizer = new com.time3.nlp.TimeNormalizer(path);
	...
	public void editTimeExp(){
		String path = com.time3.nlp.TimeNormalizer.class.getResource("").getPath();
		String classPath = path.substring(0, path.indexOf("/sdcard/TimeExp.m"));
		System.out.println(classPath+"/TimeExp.m");
		/**写TimeExp*/
		...
		try {
			com.time3.nlp.TimeNormalizer.writeModel(p, classPath+"/TimeExp.m");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
