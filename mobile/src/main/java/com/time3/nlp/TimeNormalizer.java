...
public class TimeNormalizer implements Serializable {
	...
	private static List<String> rests = new ArrayList();
	private static String[] times;

	private com.time3.nlp.TimeUnit[] timeToken = new com.time3.nlp.TimeUnit[0];
	 ...
	 * @return 返回值
	 */
	public com.time3.nlp.TimeUnit[] parse(String target, String timeBase) {
		this.target = target;
		this.timeBase = timeBase;
		this.oldTimeBase = timeBase;

		Log.d("字符串数字化-前", this.target);
		preHandling();		// 字符串预处理
		Log.d("字符串数字化-后", this.target);
	 ...
	 * @return 时间单元数组
	 */
	public com.time3.nlp.TimeUnit[] parse(String target) {
		this.target = target;
...
//			Log.d("match.group:", match.group());
		...
		Time_Result = new com.time3.nlp.TimeUnit[rpointer];
	...
	public static com.time3.nlp.TimeUnit[] filterTimeUnit(com.time3.nlp.TimeUnit[] timeUnit){
		if(timeUnit == null || timeUnit.length < 1){
			return timeUnit;
		}
		List<com.time3.nlp.TimeUnit> list = new ArrayList<>();
        for(com.time3.nlp.TimeUnit t : timeUnit){
        	if(t.getTime().getTime() != -28800000){
        		list.add(t);
        	}
        }
        com.time3.nlp.TimeUnit[] newT = new com.time3.nlp.TimeUnit[list.size()];
...
//		 System.out.print(p.pattern());
	...
	public static void main(String args[]) throws Exception {
		...
		com.time3.nlp.TimeUnit[] unit = normalizer.getTimeUnit();
